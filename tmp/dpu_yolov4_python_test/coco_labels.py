...
def get_coco_labels(add_missing=False) :
    ...
    if add_missing:
        coco_labels += [
            ...
            {"supercategory": "indoor","id":    71,"name": "hair brush"},
        ]

    coco_labels_as_array = [""] * max([item['id'] for item in coco_labels])
    for item in coco_labels:
        coco_labels_as_array[item['id']-1] = item['name']
    
    return coco_labels_as_array
    
# Print results
if __name__ == "__main__":
    print
    print(get_coco_labels())
