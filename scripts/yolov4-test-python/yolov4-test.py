...
def runDPU(dpu_1):
    ...
    while not imgQ.empty():
        img_org = imgQ.get()
        ih, iw, _ = img_org.shape
        img = pre_process(img_org, (416, 416), fixpos)
        ...
        img = draw_outputs_scale(img_org, scale, offset, outputs, class_names)
        #img = draw_outputs_scale(img_org, outputs, class_names)
