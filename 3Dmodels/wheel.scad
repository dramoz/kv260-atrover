...
wheel(
  ...
  dshaft = true, shaft_dshaft_inset = 2,
  setscrew_nut_at_shaft = false,
  setscrew_allan_key_hole = 0, //2.5 + tolerance,
  tolerance = tolerance
);/**/

/*
// Lawtina wheel dims test (small diamater)
div = 1;
tolerance = 0.35;
wheel(
  wheel_diameter = 200/div,
  wheel_width = 12 + 3,
  wheel_thickness = 10,
  
  tread_depth = 7,
  tread_tickness = 10,
  total_treads = 360/(15 * div),
...
/*
// Smaller radius for test calibration
scale_f = 3;
tolerance = 0.35;
wheel(
  wheel_diameter = 185/scale_f,
  wheel_width = 12 + 3,
  wheel_thickness = 10/scale_f,
  
  tread_depth = 5/scale_f,
  tread_tickness = 10/scale_f,
  total_treads = 360/15,
